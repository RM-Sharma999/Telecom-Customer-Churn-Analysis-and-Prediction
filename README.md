...
- Shows how churn rate varies across **Month-to-Month, One-Year, and Two-Year contracts**.
...
- Highlights churn rate distribution among different **internet service categories**.
